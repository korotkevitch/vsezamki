"""
Django settings for vsezamki project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'zamki.context_processors.all_services',
                'zamki.context_processors.all_articles',
                'zamki.context_processors.three_articles',
                'zamki.context_processors.contact',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'vsezamki.wsgi.application'
